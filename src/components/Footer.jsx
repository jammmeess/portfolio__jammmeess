    ...
    <section className="footerSec" id="Contact">
      <div className="footerSec__inner">
        <div className="footerSec__contntWrapper">
          <h2 className="footerSec__contntTtl">
            Get<span className="txtBlue">.inTouch()</span>
          </h2>
          <div className="blueDvdr"></div>
          <p className="footerSec__contntTxt">
            I'm a front-end web developer based on the Philippines, and this
            site is one of my projects crafted with ReactJS.
            <br />
            <br />
            Eager to learn more? Let's connect! Feel free to reach out to me
            through the social icons below.
          </p>
          <div className="footerSec__linkWrapper">
            <a href="mailto:james_bomediano@hotmail.com" target="_blank">
              <img className="footerSec__socialIcon" src={Email} alt="" />
            </a>
            <a
              href="https://www.linkedin.com/in/kristoffer-james-bomediano-020214271/"
              target="blank"
            >
              <img className="footerSec__socialIcon" src={LinkedIn} alt="" />
            </a>
            <a
              href="https://github.com/jammmeess?tab=repositories"
              target="blank"
            >
              <img className="footerSec__socialIcon" src={Github} alt="" />
            </a>
          </div>
        </div>

        <div className="footerSec__cntctWrapper">
          <h3 className="footerSec__cntctTtl">
