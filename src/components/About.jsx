    ...
    <section className="aboutSec" id="About">
      ...
      <div className="aboutSec__inner subCont">
        <div className="aboutSec__lowerContntWrap">
          ...
          <div
            className="aboutSec__ttlWrap"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <h3 className="aboutSec__subTtl">
              <span class="blink">_</span>myName.
              <span className="txtBlue">is()</span>
            </h3>
            <br class=" u-pcDb" />
            <h2 className="aboutSec__ttl lowerTtl">
              Kristoffer <br />
              Bomediano
            </h2>
            <p></p>
