    ...
    return (
        <section className="expSec" id="Experience">
          <div className="expSec__inner">
            <div className="expSec__ttlCont" data-aos="fade-zoom-in" data-aos-duration="1000">
              <h2 className="expSec__ttl">_work<span className="txtBlue">Experience.()</span></h2>
            </div>
            <div className="expSec__wrkWrapper">
              <div className="expSec__wrkCont" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
              ...
              <div className="expSec__wrkCont" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
              ...
              <div className="expSec__wrkCont" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
              ...
              <div className="expSec__wrkCont" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
